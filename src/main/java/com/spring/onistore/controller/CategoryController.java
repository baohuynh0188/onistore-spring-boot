...
getCategoryByName(@PathVariable(value = "category_name") String categoryName)
...
public ResponseEntity<List<Category>> getCategoryBySlug(@PathVariable(value =
"category_slug") String categorySlug) throws ResourceNotFoundException {
List<Category> categories =
categoryRepository.findByCategorySlug(categorySlug);
return ResponseEntity.ok().body(categories);
}
...
public ResponseEntity<Category> updateCategory(@PathVariable(value = "id")
Long categoryId, @RequestBody Category categoryDetail) throws
ResourceNotFoundException {
Category category = categoryRepository.findById(categoryId).orElseThrow(() ->
new ResourceNotFoundException("Category " + categoryId + " is not exist"));
...
public Map<String, Boolean> deleteCategory(@PathVariable(value = "id") Long
categoryId) throws ResourceNotFoundException {
Category category = categoryRepository.findById(categoryId).orElseThrow(() ->
new ResourceNotFoundException("Category " + categoryId + " is not exist"));
