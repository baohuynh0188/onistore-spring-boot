...
// Long productId) throws ResourceNotFoundException {
...
// public ResponseEntity<List<Product>> getProductBySlug(@PathVariable(value =
// "product_slug") String productSlug) throws ResourceNotFoundException {
